...
from mlmodule.cli.types import ArgMlModuleOptions, CLICommandDefinition


def check_perf_fun(options: ArgMlModuleOptions) -> None:
...
COMMAND = CLICommandDefinition(
    ...
    options_class=ArgMlModuleOptions,
)
