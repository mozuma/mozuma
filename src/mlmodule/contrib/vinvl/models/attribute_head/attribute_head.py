...
from mlmodule.contrib.vinvl.models.attribute_head.roi_attribute_predictors import AttributeRCNNPredictor
from mlmodule.contrib.vinvl.models.attribute_head.inference import AttributePostProcessor
...
class ROIAttributeHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None):
        ...
        result = self.post_processor(
            attribute_logits, proposals, attribute_features)
        return x, result, {}
