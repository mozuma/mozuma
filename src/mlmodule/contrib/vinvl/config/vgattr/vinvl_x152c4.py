config = [
    ...
    "AttrRCNN",
    "MODEL.WEIGHT",
    "pretrained_model/gqa/gqa_X152C4_vrdvgvrd_lr0.003_bsz8_objscore005_nooverlap/model_0080000.pth",
    ...
    "DATASETS.LABELMAP_FILE",
    "visualgenome/VG-SGG-dicts-vgoi6-clipped.json",
]
